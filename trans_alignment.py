...
if __name__ == '__main__':
    ...
    parser.add_argument("-path_mafft", "--path_to_mafft", type=str,
                        help="Path to mafft", required=True)
    args = parser.parse_args()
    #args.path_to_mafft = 'D:\\Programs\\mafft-win\\'
    ...
    if sys.platform == 'win32' or sys.platform == 'cygwin':
        #--op 15 --ep 3
        os.system(('{}  --retree 1 ' + trans_file+ ' > ' + trans_file_aln).format(args.path_to_mafft+'mafft.bat'))
    else:
        os.system(('{} --op 15 --ep 3 --retree 1 ' + trans_file+ ' > ' + trans_file_aln).format(args.path_to_mafft+'mafft'))
